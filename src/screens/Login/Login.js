									...
									<>
										<View style={styles.contentContainer}>
											...
											<View style={{marginVertical: SIZES.font1}}>
												<InputBox name="partner_email" label="Registered Email" keyboardType="email-address" value={values.partner_email} onChangeText={handleChange('partner_email')} error={touched.partner_email && errors.partner_email ? errors.partner_email : null} />
											</View>
