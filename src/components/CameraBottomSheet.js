...
const ImageBottomSheet = React.forwardRef(({onSelectImage, handleClosePress, type, onCoverPhotoSelect}, ref) => {
	...
	return (
		<BottomSheet ref={ref} handleIndicatorStyle={styles.sheetHandleStyle} backdropComponent={renderBackdrop} index={-1} snapPoints={snapPoints} enablePanDownToClose>
